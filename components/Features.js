    ...
    <div className="container mx-auto bg-[#cafff3] rounded-[5rem]">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-16 py-10 lg:py-20">
        <div className="flex flex-col gap-5 ">
          <Image width={500} height={500} src="/assets/work1.jpg" alt="w1" className="rounded-[2.5rem]"/>
        ...
        <div className="flex flex-col gap-5 ">
          <Image width={500} height={500} src="/assets/work2.jpg" alt="w2" className="rounded-[2.5rem]" />
        ...
        <div className="flex flex-col gap-5 ">
          <Image width={500} height={500} src="/assets/work3.jpg" alt="w3" className="rounded-[2.5rem]" />
